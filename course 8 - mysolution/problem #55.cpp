...
sDate CalculateVcationReturnDate(sDate DateFrom, short VcationDate)
{
	while (VcationDate > 0)
	{
	...
	for (int i = 0; i < VcationDate + WeekEndCounter; i++)
	{
...
int main()
{
	...
	short VcationDays;
	cout << "\npls enter vacation days? ";
	cin >> VcationDays;

	Date1 = CalculateVcationReturnDate(Date1,VcationDays);
	string ReturnDate = DayShortName(DayOfWeekOrder(Date1));
	cout << "\n\nReturn Date :" << ReturnDate << " , " << Date1.Day << "/" << Date1.Month << "/" << Date1.Year;
